<?
	...
	if ($result) {
		if (mysqli_num_rows($result) == 0) {
			...
			echo ("<form action=\"javascript: formAction('deleteAllNotifications.php', ['deleteAll'], ''); formAction('viewNotifications.php', ['viewNotifications'], 'notificationsList')\" style=\"display: inline\"><input type=\"submit\" id=\"deleteAll\" value=\"Delete all\"></form>");
			echo("\t\t</ul>");
		}
	}
